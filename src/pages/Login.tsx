    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans p-4">
      <Card className="w-full max-w-md border-slate-200 shadow-sm rounded-xl">
        <CardHeader className="text-center space-y-3 pb-8">
          ...
          <CardTitle className="text-2xl font-bold text-slate-800">SI-SUKET MEDIS</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button type="submit" className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg text-sm font-bold shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-colors">
              Masuk Sistem
            </button>
          </form>
        </CardContent>
